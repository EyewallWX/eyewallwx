...
| ![Source: NOAA](images/tier1/satellites%201.webp) | ![Source: ESA](images/tier1/satellites%202.webp)               | ![Source: Navy.mil](images/tier1/satellites%203.webp)       |
| ------------------------------------------------ | ------------------------------------------------------------- | ---------------------------------------------------------- |
...
| ![Source: tropicaltidbits.com](images/tier1/landfall.webp) |
| --------------------------------------------------------- |
#### Eyewall 
...
| ![Source: Mexican meteorological agency](images/tier1/eyewall1.webp) | ![Source: Radarscope](images/tier1/eyewall.webp) |
| ------------------------------------------------------------------- | ----------------------------------------------- |
#### Eye
...
| ![](images/tier1/eye1.webp) | ![Source: NOAA/JMA](images/tier1/eye2.webp) | ![](images/tier1/eye3.webp) |
| -------------------------- | ------------------------------------------ | -------------------------- |
#### Tropical waves
...
| ![Source: NOAA](images/tier1/Tropical%20Waves%201.webp) | ![source: NWS](images/tier1/Tropical%20Waves%202.webp) |
| ------------------------------------------------------ | ----------------------------------------------------- |
...
| ![Source: unknown](images/tier1/aew.webp) |
| ---------------------------------------- |
...
| ![](images/tier1/IR.webp) | ![](images/tier1/IR2.webp) | ![](images/tier1/IR4.webp) |
| ------------------------ | ------------------------- | ------------------------- |
...
| ![200mb flow. source: tropicaltidbits.com](images/tier1/Anticyclone.webp) | ![500mb height. source: tropicaltidbits.com](images/tier1/Anticyclone%202.webp) |
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
...
| ![](images/tier1/medicane1.webp) | ![](images/tier1/medicane2.webp) |
| ------------------------------- | ------------------------------- |
...
| ![250mb flow showcasing enhanced areas of flow in a circle around the pole - the jet stream. Source: tropicaltidbits.com](images/tier1/jetstream.webp) |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- |
#### Saharan Air Layer
...
| ![](images/tier1/ascat1.webp) | ![](images/tier1/ascat2.webp) |
| ---------------------------- | ---------------------------- |
| ![](images/tier1/ascat3.webp) | ![](images/tier1/ascat4.webp) |
|                              |                              |
...
| ![Source: tropicaltidbits.com](images/tier1/entrainment1.webp) | ![Source: cyclonicwx.com](images/tier1/entrainment2.webp) | ![Source: @TropicalCycloneStuff](images/tier1/entrainment4.webp) |
| ------------------------------------------------------------- | -------------------------------------------------------- | --------------------------------------------------------------- |
...
| ![](images/tier1/subtropical1.webp) | ![](images/tier1/subtropical2.webp) | ![](images/tier1/subtropical3.webp) |
| ---------------------------------- | ---------------------------------- | ---------------------------------- |
#### SAR
...
| ![](images/tier1/sar1.webp) | ![](images/tier1/sar2.webp) |
| -------------------------- | -------------------------- |
| ![](images/tier1/sar3.webp) | ![](images/tier1/sar4.webp) |
|                            |                            |
...
| ![Windspeed, temperature and pressure readings from the peak of Hurricane Erin 2025. Source: tropicaltidbits.com](images/tier2/recon1.webp)                                       | ![Windspeed, temperature and pressure readings from Hurricane Erin 2025. Source: tropicaltidbits.com](images/tier2/recon2.webp)                                                                                  | ![Dropsonde from the eye of Erin showing 60kt winds and 919mb pressure. Reduced 1mb/10kt we arrive at a pressure reading of 913mb. Source: cyclonicwx.com](images/tier2/recon3.webp) |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Windspeed, temperature and pressure readings from Hurricane Erin 2025 showing an asymmetric (one side stronger) eyewall. Source: tropicaltidbits.com](images/tier2/recon4.webp) | ![Windspeed and wind field data from Hurricane Erin showcasing the wide wind field of the storm. Source: tropicaltidbits.com](images/tier2/recon5.webp)                                                          | ![Tail-end doppler radar showing the rain and wind field plots of Hurricane Erin 2025. Source: unknown](images/tier2/recon6.webp)                                                    |
| ![Tail-end doppler radar showing the wind field of Hurricane Erin 2025. Source: arctic.som.ou.edu](images/tier2/recon7.webp)                                                      | ![Single 10m wind plot showing extreme winds in the eyewall of hurricane Erin, as well as the relative calm in the eye itself as noted on the wind barbs. Source: tropicaltidbits.com](images/tier2/recon8.webp) | ![Photograph taken by a recon plane crew member from the eye of Hurricane Erin. Source: twitter.com](images/tier2/recon9.webp)                                                       |
|                                                                                                                                                                                  |                                                                                                                                                                                                                 |                                                                                                                                                                                     |
...
| ![Oceanic Heat Content in the north Atlantic ocean in late August 2025. Source: isotherm.rsmas.miami.edu](images/tier2/OHC.webp) |
| ------------------------------------------------------------------------------------------------------------------------------- |
...
| ![Typhoon Hagibis 2019](images/tier2/pinhole%201.webp) | ![Hurricane Milton](images/tier2/pinhole%203.webp) |
| ----------------------------------------------------- | ------------------------------------------------- |
| ![Typhoon Rai 2021](images/tier2/pinhole%202.webp)     | ![Hurricane Wilma](images/tier2/pinhole%204.webp)  |
|                                                       |                                                   |
...
| ![](images/tier1/ensemble1.webp) | ![](images/tier1/ensemble2.webp) |
| ------------------------------- | ------------------------------- |
| ![](images/tier1/ensemble3.webp) | ![](images/tier1/ensemble4.webp) |
|                                 |                                 |
...
| ![Outflow boundaries emanating from Tropical Storm Tammy. Source: tropicaltidbits.com](images/tier2/ofb.webp) |
| ------------------------------------------------------------------------------------------------------------ |
...
| ![](images/tier2/cdo1.webp) | ![](images/tier2/cdo2.webp) |
| -------------------------- | -------------------------- |
| ![](images/tier2/cdo3.webp) | ![](images/tier2/cdo4.webp) |
|                            |                            |
...
| ![](images/tier2/ewrc1.webp) | ![](images/tier2/ewrc2.webp) |
| --------------------------- | --------------------------- |
...
| ![Hurricane Fiona undergoing extratropical transition, Source: tropicaltidbits.com](images/tier2/ext.webp) |
| --------------------------------------------------------------------------------------------------------- |
...
| ![Source: uknown](images/tier2/gyre1.webp) | ![source: weathernerds.com](images/tier2/gyre2.webp) |
| ----------------------------------------- | --------------------------------------------------- |
...
| ![](images/tier2/cutoff1.webp) | ![](images/tier2/cutoff2.webp) |
| ----------------------------- | ----------------------------- |
...
| ![](images/tier2/vht1.webp) | ![](images/tier2/vht2.webp) |
| -------------------------- | -------------------------- |
...
| ![](images/tier2/flow1.webp) | ![](images/tier2/flow2.webp) |
| --------------------------- | --------------------------- |
| ![](images/tier2/flow3.webp) | ![](images/tier2/flow4.webp) |
|                             |                             |
...
| ![ENSO regions](images/tier2/enso1.webp) | ![El Nino](images/tier2/enso2.webp) | ![La Nina](images/tier2/enso3.webp) |
| ---------------------------------------- | ----------------------------------- | ----------------------------------- |
#### Stadium Effect
...
| ![TUTT and other tropical features seen on WV imagery](images/tier2/tutt1.webp) | ![TUTT seen over the eastern Atlantic in 200mb flow model data. Source: tropicaltidbits.com](images/tier2/tutt2.webp) |
| ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
...
| ![MJO forecast for the next ~30d. Source: www.bom.gov.au](images/tier3/mjo2.webp) | ![3 week global hazards forecast. Source: www.cpc.ncep.noaa.gov](images/tier3/mjo.webp) |
| -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
...
| ![Radar loop of cyclone Zelia. Source: Radarscope](images/tier4/feeder%20band%201.webp) | ![Radar image still of Hurricane Ida. Source: Radarscope](images/tier4/feeder%20band%202.webp) |
| -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
#### Stable cirrus band
...
| ![Typhoon Krathon 2024. Source: tropicaltidbits.com](images/tier4/stable%20cirrus%20band%201.webp) | ![Cyclone Chido 2024. Source: tropicaltidbits.com](images/tier4/stable%20cirrus%20band%202.webp) |
| ------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
#### Cirrus vortex tubes
...
| ![Source: Isaac G](images/tier4/cirrus%20vortex%20tubes.webp) |
| ------------------------------------------------------------ |
...
| ![Source: Dunion et. al. 2014](images/tier4/diurnal%20cycle.webp) |
| ---------------------------------------------------------------- |
...
| ![Infrared imagery gif showing cooler temperatures (cirrus clouds) in the mountains of Hainan. Source: tropicaltidbits.com](images/tier4/orographic%20waves.webp) | ![Cross section of omega anomalies showing upward movement along the mountains. Source: tropicaltidbits.com](images/tier4/orographic%20waves2.webp) |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| !["DIURNAL PULSE EXAMPLE: HURRICANE SAM (2021). Source: unknown](images/tier4/diurnal%20pulse.webp) |
| -------------------------------------------------------------------------------------------------- |
...
| ![Trochoidal wobbles. Source: tropicaltidbits.com](images/tier4/wobbles.webp) |
| ---------------------------------------------------------------------------- |
